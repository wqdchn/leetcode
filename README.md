...
|236|[Lowest Common Ancestor of a Binary Tree](https://leetcode.com/problems/implement-queue-using-stacks/) | [Java](https://github.com/wqdchn/leetcode/blob/master/src/meidum/Lowest_common_ancestor_of_a_binary_tree.java), [Python](https://github.com/wqdchn/geektime/blob/master/algorithm-40case/tree/lowest_common_ancestor_of_a_binary_tree.py)|Medium|
