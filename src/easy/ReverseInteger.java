...
/**
 * @program: leetcode
 * @description: Given a 32-bit signed integer, reverse digits of an integer. Assume we are dealing
 * with an environment which could only store integers within the 32-bit signed integer range:
